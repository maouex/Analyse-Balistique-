...
export function BentoSpotlight({
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      const section = grid.closest('.bento-grid-section') ?? grid;
      const rect = section.getBoundingClientRect();
      const mouseInside =
        e.clientX >= rect.left && e.clientX <= rect.right &&
        e.clientY >= rect.top && e.clientY <= rect.bottom;

      const cards = grid.querySelectorAll<HTMLElement>('.widget-bento--border-glow');
    ...
    const handleMouseLeave = () => {
      grid.querySelectorAll<HTMLElement>('.widget-bento--border-glow').forEach((card) => {
